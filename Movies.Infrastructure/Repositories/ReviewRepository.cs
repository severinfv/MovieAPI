...
public class ReviewRepository : RepositoryBase<Review>, IReviewRepository
{
    ...
    public async Task<Review?> GetByIdAsync(int id, bool trackChanges = false)
    {
    ...
    public async Task<IEnumerable<Review>> GetReviewsByMovieIdAsync(int movieId, bool trackChanges = false)
